...
const TestInput = ({ onStartTest }) => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Start Your Test</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          <label htmlFor="testCreator" className="block text-sm font-medium text-gray-700 mb-1">
            Test Creator
          </label>
          <input
            type="text"
        ...
        >
          <button
            type="submit"
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-md transition duration-150 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50"
          >
            Start Test
          </button>
        </motion.div>
